...
#'
#' @description \code{nh_analysis_data_generateR} Quickly creates simulated reference populations from user provided data, and merges these with the genotypes of unknown/experimental individuals, producing a file to be analyzed by NewHybrids
...
#' @param UnknownIndivs A dataframe generated by extracting the genotypes of the individuals to be analyzed for hybrid category using the functions genepop_XXX and genepop_flatten from the package GenePop XX. Note - the number of loci in ReferencePopsData must equal the number in UnkownIndivs
